...
class Gui(Tk):
    ...
    def __init__(self):
        ...
        # load resources
        self.cacti_before_image = PhotoImage(file="2-GUI\\4-Images\\2-swapping\\cacti_before.gif")
        self.cacti_after_image = PhotoImage(file="2-GUI\\4-Images\\2-swapping\\cacti_after.gif")

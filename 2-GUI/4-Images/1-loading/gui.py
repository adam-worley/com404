...
class Gui(Tk):
    ...
    def __init__(self):
        ...
        # load resources
        self.ambulance_image = PhotoImage(file="2-GUI\\4-Images\\1-loading\\ambulance.gif")
        self.bike_image = PhotoImage(file="2-GUI\\4-Images\\1-loading\\bike.gif")
        self.plane_image = PhotoImage(file="2-GUI\\4-Images\\1-loading\\plane.gif")
